...
<body>
		...
		<header class="blog-header py-3">
			<div
				...
				<div class="col-4 pt-1">
					<a class="link-secondary" href="#">Subscribe LOJA 3</a>
				</div>
		...
		<div class="nav-scroller py-1 mb-2">
			<nav class="nav d-flex justify-content-between">
				<a class="p-2 link-secondary"
					href="./loja?action=gato">GATOS</a>
				<a class="p-2 link-secondary" href="#">U.S.</a> <a
	...
	<main class="container">
		...
		<div class="row mb-2">
			...
			<c:forEach items="${listProdutoPorTipo}" var="produto">
				...
				<div class="col-md-3">
					<div
						...
						<div class="col p-4 d-flex flex-column position-static">
							...
							<a
								href="${pageContext.request.contextPath }/carrinho?&action=comprar&id=${produto.getId()}"
								class="stretched-link">comprar</a>
			...
			<hr class="my-4">
			<a href="${pageContext.request.contextPath }/carrinho?action=resumo">RESUMO
				DA COMPRA</a>
