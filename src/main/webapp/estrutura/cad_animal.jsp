  ...
  <main>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">ANIMAL</h4>
        <form class="needs-validation"   action="<%= request.getContextPath() %>/AnimalSalvarServlet" method="get" novalidate>
          <div class="row g-3">
            <div class="col-sm-12">
            ...
            <div class="col-9">
              ...
              <input type="text" class="form-control" id="raca" placeholder="labrador, ...">
              <div class="invalid-feedback">
                Insira uma raça
              </div>
            </div>
             <div class="col-3">
              ...
              <input type="text" class="form-control" id="idade" placeholder="">
              <div class="invalid-feedback">
                Insira uma idade
              </div>
            </div>
